...
Um den Cache Agenten zu bestimmen, der für die Adresse \texttt{30A0} zuständig ist, müssen wir zu erst die Adresse in die gegebene Formel einsetzen:
...
Der Cache Agent 4 (null indiziert) ist zuständig. Die Adresse fällt in den Zuständigkeitsbreich des Home Agents 3 (auch null inidiziert).
...
Genau wie bei Aufgabe b müssen wir zu erst den Cache Agenten bestimmen:
...
Es könnte Argumentiert werden, dass RFO Modifizierungen impliziert. Ob jetzt in den Zustand Modified oder Exclusive übergegangen wird, habe ich nicht klar aus den Folien herauslesen können. Deshalb sei hiermit gesagt, dass wir uns über dieses Sachverhalt Gedanken gemacht haben.
