...
\texttt{0x10} ist hexadezimal für 16. Also 16 Bytes pro Cachezeile.

\subsubsection*{b) - Zugriff auf Shared Data}

$$
f(\texttt{0x30A0}) = \frac{\texttt{0x30A0}}{\texttt{0x10}} \mod 6 = \frac{12448}{16} \mod 6 = 778 \mod 6 = 4
$$
